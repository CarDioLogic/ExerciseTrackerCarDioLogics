...
public class RawSQLSessionRepository : ISessionRepository
{
    ...
    public Session GetSessionById(int id)
    {
        ...
        {
            connection.Open();
            string query = "SELECT Id, DateStart, DateEnd, Duration, Comment FROM Sessions WHERE Id = @Id"; //what is name where??
    ...
    public void AddSession(Session session)
    {
        using (var connection = new SqlConnection(_connectionString))
        {
            ...
            string query = "INSERT INTO Sessions (DateStart, DateEnd, Duration, Comment) VALUES (@DateStart, @DateEnd, @Duration, @Comment)";
    ...
    public void UpdateSession(Session session)
    {
        using (var connection = new SqlConnection(_connectionString))
        {
            ...
            string query = "UPDATE Sessions SET DateStart = @DateStart, DateEnd = @DateEnd, Duration = @Duration, Comment = @Comment WHERE Id = @Id";
    ...
    public List<Session> GetAllSessions()
    {
        ...
        using (var connection = new SqlConnection(_connectionString))
        {
            ...
            string query = "SELECT Id, DateStart, DateEnd, Duration, Comment FROM Sessions";
            using (var command = new SqlCommand(query, connection))
            {
                using (var reader = command.ExecuteReader())
                {
